 ...
 *
 * The keyboard trigger lives in the lightweight loader at
 * `command-palette.tsx`; this implementation is loaded lazily on first
 * activation so it doesn't bloat the initial bundle of every route.
 */
export function CommandPaletteImpl({ open, onClose }: CommandPaletteImplProps) {
