...
Widget _wrap({
  ...
  return ProviderScope(
    overrides: [
      ...
      verticalSectionProvider(const VerticalSectionParams('travel')).overrideWith((ref) async => travel),
      verticalSectionProvider(const VerticalSectionParams('stories')).overrideWith((ref) async => stories),
