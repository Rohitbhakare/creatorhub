...
| E5.5 | Publishing Wizard (TipTap editor + 2:1 cover crop + drag-reorder + 5-state autosave + iframe preview) | `DONE` (axe + screenshots pending) | 10/10 | `[x]` 334 web (+24 new) | `[x]` | `[x]` | `[x]` self-review (4 dims) | `[x]` | `[-]` N/A | `[-]` N/A | `[ ]` pending |
