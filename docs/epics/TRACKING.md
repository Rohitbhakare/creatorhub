...
| E5.6 | Auth + Onboarding (3-tab signup: email+password / phone OTP / Google + magic-link reset + 200-particle welcome burst) | `DONE` (axe + Lighthouse pending) | 9/9 | `[x]` 334 web (8 existing signin tests updated for tabs) | `[x]` | `[x]` | `[x]` self-review (4 dims) | `[x]` | `[-]` N/A | `[-]` N/A | `[ ]` pending |
