...
> Last updated: 2026-04-25 (Taxonomy rollout — 3-level content hierarchy seeded + create wizard + feed sub-cat chips + Discover section; guest onboarding refactor — isGuest param, 3 redundant screens deleted)
