...
| E5.4 | Booking (dual-month calendar + 4-step wizard chrome + SSE seat stream + Razorpay + confetti + .ics) | `DONE` (Lighthouse + axe + Razorpay e2e pending) | 11/11 | `[x]` 310 web (+25 new) | `[x]` | `[x]` | `[x]` self-review (4 dims) | `[x]` | `[-]` N/A (no migrations needed) | `[-]` N/A | `[ ]` pending |
