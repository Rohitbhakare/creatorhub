...
| E5.3 | Reader / Detail (Magazine + Compact, parallax, drop-caps, inline spots, spot save) | `DONE` (Lighthouse + axe pending) | 13/13 | `[x]` 292 web tests (+34 new) | `[x]` | `[x]` | `[x]` self-review (4 dims) | `[x]` | `[-]` N/A | `[-]` N/A | `[ ]` pending |
